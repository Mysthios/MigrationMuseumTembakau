...
@section('title', 'Program Donasi Museum')

@section('content')
<section class="py-12 bg-white">
    <div class="container mx-auto px-6">
        <h2 class="text-3xl font-bold text-center">Program Donasi</h2>
        <p class="text-gray-700 text-center mt-2">Dukung museum kami dengan berdonasi.</p>
